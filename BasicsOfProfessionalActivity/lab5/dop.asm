...
sum_support:
	jump $sum
read_symb2: ; читает 2 символ введенный в цифровую панель
	in 0x1d
	and #0x40
	beq read_symb2
	in 0x1c
...
multi_num2_10: ;умножение на 10 (10y) 
	asl
	asl 
	asl 
	st $tmp
...
multi_num1_10: ;умножение на 10 (10x) 
	asl
	asl
	asl
	st $tmp
...
multi_num1_100: ; умножение на 100 (100x)
	asl
	asl
	asl
	asl
