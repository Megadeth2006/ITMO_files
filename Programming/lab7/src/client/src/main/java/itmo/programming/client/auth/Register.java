...
/**
 * Команда регистрации для формирования запроса.
 */
public class Register implements Base {
     ...
     */
    public Register(ConsoleInputManager inputManager, AuthManager authManager) {
    ...
    public Request execute(String[] args) throws IOException {
        ...
        return new Request("register", null,
