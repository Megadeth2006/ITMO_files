...
public class Client {
    ...
    public void start() {
        try {
            ...
            final RequestFactory requestFactory = new RequestFactory(askManager, requestSender);
            final ConsoleManager consoleManager = new ConsoleManager(requestFactory, requestSender);
