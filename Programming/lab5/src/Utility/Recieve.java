...
public class Recieve {
    ...
    public static SpaceMarine takeSpaceMarine(Console console, int id) throws BreakRecieve {
        try {
            String name;
            long health;
            String achievements;
        ...
        try {
            ...
            while (true) {
                ...
                if (!line.isEmpty()) {
                    ...
                    } catch (NumberFormatException e) {console.printErr("Введите число!");}
                }
    ...
    public static MeleeWeapon takeMeleeWeapon(Console console) throws BreakRecieve{
        try{MeleeWeapon weapon;
            while (true){
                console.print("Введите Meleeweapon (" + MeleeWeapon.names() + ") :");
                var line = console.readln().trim();
                if (line.equals("exit")) throw new BreakRecieve("Выполнен выход");
                if (!line.isEmpty()) {
                    try {
