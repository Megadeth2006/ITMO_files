...
-- Ответ должен содержать только одно число. Доп: (сделать с подзапросами без join)
select count(b."ИМЯ")
from "Н_УЧЕНИКИ" a
...
-- у которых средняя оценка равна максимальной оценк(е|и) в группе 3100. Доп: Добавить вывод среднего возраста
